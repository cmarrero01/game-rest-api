...
function ProcessQueuedUpdateStatement()
{
	...
	if ( strlen($CFGCOD4['Pass'] > 0) )
		$myCommand = $content['MYSQLPATH'] . " -u " . $CFGCOD4['User'] . " -p" .$CFGCOD4['Pass'] . " " . $CFGCOD4['DBName'] . " < " . $content['sqltmpfile'];
	else
		$myCommand = $content['MYSQLPATH'] . " -u " . $CFGCOD4['User'] . " " . $CFGCOD4['DBName'] . " < " . $content['sqltmpfile'];
