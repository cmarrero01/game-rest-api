<div style="margin:0; padding:0; margin:0 auto;">
    <div id="wrapp" style="background-color:#111111; margin: 0 auto; width: 600px;">
        ...
        <div class="content" style="padding: 20px 75px;">
            <h2 style="color:#fff; font-size:20px; font-family:arial;">BETA starts...NOW!</h2>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                <strong>And so.. it begins.</strong><br />
                Battlepro is up and running. We're developing something new, a new face to gaming competition. <br /><br />
                In Battlepro you're going to be able to compete for real money prizes, while you enjoy your favorite games. <br /><br />
                What makes us different, among many things, is a fully automated system, where you can play with your friends, <br />
                or anyone in the platform, at any time and for different amounts of real cash.<br />
            </p>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                We're aware that we are going to need a lot of help from the community, since the final product is just for you. <br /><br />
                So we ask you to help us develop this place, so it grows into something greater than we could do by ourselves. <br /><br />
                From the forum area, feedback and email, you can give us your opinions and suggestions about things you like and <br />
                things you would like being done differently. With competitions like this, you will be able to have constant activity, <br /><br />
                being able to control the skill level of the people you play with while improving your own.<br />
            </p>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                We decided to create Battlepro because we saw something in the market that we wanted to improve. <br /><br />
                We are determined to see many more professional players, a lot more interaction, and we wish to create a place where <br />
                thousands of players can say that they're wining money from what they do, that they are living doing what they love.<br />
            </p>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                <strong>And so, without further ado</strong><br />
                We give to you</strong><br />
            </p>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                Sincerely,
            </p>
