<div style="margin:0; padding:0; margin:0 auto;">
    <div id="wrapp" style="background-color:#111111; margin: 0 auto; width: 600px;">
        ...
        <div class="content" style="padding: 20px 75px;">
            <h2 style="color:#fff; font-size:20px; font-family:arial;">Your friend <?=$nicename;?> invite you to prove your skills</h2>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                <strong>Follow this link access to <a href="http://battlepro.com/en/referal/code/<?=$referalCode;?>">battlepro.com</a> </strong><br />
                or copy and past this URL: <pre>http://battlepro.local/en/referal/code/<?=$referalCode;?></pre><br />
            </p>
            <p style="color:#ccc; font-size:15px; font-family:arial; line-height: 1.5;">
                <?=$message;?>
            </p>
